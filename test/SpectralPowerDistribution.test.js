...
describe('SpectralPowerDistribution', () => {
  describe('interval', () => {
    ...
    it('throws an error if the wavelengths are at irregular intervals', () => {
      ...
      assert.throws(() => distribution.interval, 'Wavelengths are at irregular intervals');
    });
  });

  describe('wavelengths', () => {
    it('returns an array of the wavelengths', () => {
      const distribution = new SpectralPowerDistribution([[380, 1], [385, 2], [390, 3], [395, 4], [400, 5]]);
  ...
  describe('measurements', () => {
    it('returns each measurement as its own array of arrays', () => {
      const distribution = new SpectralPowerDistribution([[380, 1, 10], [385, 2, 20], [390, 3, 30], [395, 4, 40], [400, 5, 50]]);
