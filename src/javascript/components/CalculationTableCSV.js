...
const CalculationTableCSV = ({
  ...
  const csv = Papa.unparse([
    ...
    [radianceOrIrradiance === 'radiance' ? 'Luminance [cd/m²]' : 'Illuminance [lux]', ...luminanceTotals],
    ...
    [`S-cone-opic ${equivalentDaylightUnit}`, ...equivalentDaylightAlphaOpic.sc],
    [`M-cone-opic ${equivalentDaylightUnit}`, ...equivalentDaylightAlphaOpic.mc],
    [`L-cone-opic ${equivalentDaylightUnit}`, ...equivalentDaylightAlphaOpic.lc],
