...
export const createCalculationTable = (
  table,
  ...
  const equivalentDaylightAlphaOpic = calculateEquivalentDaylightAlphaOpic(
    sConeTotals,
    mConeTotals,
    lConeTotals,
    rodTotals,
  ...
  const alphaOpicEfficiency = calculateAlphaOpicEfficiency(
    sConeTotals,
    mConeTotals,
    lConeTotals,
    rodTotals,
  ...
  if (!simplifiedReport) {
    createTableRow(
      table,
      "CIE 1931 xy chromaticity (x)",
      chromaticity31XValues,
      asDecimal
    );
    createTableRow(
      table,
      "CIE 1931 xy chromaticity (y)",
      chromaticity31YValues,
      asDecimal
    );
    createTableRow(
      table,
      "CIE 1964 x₁₀y₁₀ chromaticity (x₁₀)",
      chromaticity64XValues,
      asDecimal
    );
    createTableRow(
      table,
      "CIE 1964 x₁₀y₁₀ chromaticity (y₁₀)",
      chromaticity64YValues,
      asDecimal
    );
  ...
  createTableRow(
    table,
    `S-cone-opic ${radianceOrIrradiance} (${units})`,
    sConeTotals,
    asDecimal
  );
  createTableRow(
    table,
    `M-cone-opic ${radianceOrIrradiance} (${units})`,
    mConeTotals,
    asDecimal
  );
  createTableRow(
    table,
    `L-cone-opic ${radianceOrIrradiance} (${units})`,
    lConeTotals,
    asDecimal
  );
  createTableRow(
    table,
    `Rhodopic ${radianceOrIrradiance} (${units})`,
    rodTotals,
    asDecimal
  );
  createTableRow(
    table,
    `Melanopic ${radianceOrIrradiance} (${units})`,
    melTotals,
    asDecimal
  );
  ...
  createTableRow(
    table,
    `Rhodopic ${equivalentDaylightUnit}`,
    equivalentDaylightAlphaOpic.rh,
    asDecimal
  );
  createTableRow(
    table,
    `Melanopic ${equivalentDaylightUnit}`,
    equivalentDaylightAlphaOpic.mel,
    asDecimal
  );
  ...
  createTableRow(
    table,
    `S-cone-opic ${alphaOpicEfficiencyUnit}`,
    alphaOpicEfficiency.sc,
    asDecimal
  );
  createTableRow(
    table,
    `M-cone-opic ${alphaOpicEfficiencyUnit}`,
    alphaOpicEfficiency.mc,
    asDecimal
  );
  createTableRow(
    table,
    `L-cone-opic ${alphaOpicEfficiencyUnit}`,
    alphaOpicEfficiency.lc,
    asDecimal
  );
  createTableRow(
    table,
    `Rhodopic ${alphaOpicEfficiencyUnit}`,
    alphaOpicEfficiency.rh,
    asDecimal
  );
  createTableRow(
    table,
    `Melanopic ${alphaOpicEfficiencyUnit}`,
    alphaOpicEfficiency.mel,
    asDecimal
  );
};
